...
<div class="row justify-content-center">
    ...
    <div class="col-8">
        ...
        <div class="row">
            <div class="col-4">
                <button class="productSize" style="width:auto; padding-left:10px; padding-right:10px; height:40px;">Playeras - L</button>   <button class="productSize" style="width:auto; padding-left:10px; padding-right:10px; height:40px;">Quitar</button>
            </div>
