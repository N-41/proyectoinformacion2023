...
<div class="row">
    ...
    <div class="col-5">
        ...
        <p style="text-align:left; font-size:1.3rem">Balon de soccer dorado 58cm</p>
        <p style="text-align:left; font-size:0.9rem">Talla</p>
        ...
        <p />
        <div style="font-size:2rem; color:white; font-weight:bold;">Cantidad: <input type="number" id="ammount" name="ammount" min="1" max="14">/14</div>
        <p> </p>
        <a href="#"><button class="productButton" style="background:yellow;">Agregar al carrito</button></a>
        <p> </p>
        <a href="index.html"><button class="productButton" style="background:white;">Seguir comprando</button></a>
    </div>
</div>
<p></p>
`;
